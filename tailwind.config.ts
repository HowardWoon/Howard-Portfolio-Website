  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        clay:
          "inset 3px 3px 6px rgba(255,255,255,0.65), inset -4px -4px 8px rgba(0,0,0,0.18), 3px 3px 0 0 #0A0A0A",
        "clay-pressed":
          "inset 4px 4px 8px rgba(0,0,0,0.22), inset -2px -2px 6px rgba(255,255,255,0.5)",
      },
      borderWidth: {
        3: "3px",
      },
