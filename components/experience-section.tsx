  ...
  const events = [
        ...
        desc: (
          <div className="space-y-6 pt-2">
            ...
            <div className="space-y-2">
              <h5 className="font-display text-ink font-extrabold text-base uppercase tracking-[-0.01em] border-b-2 border-ink pb-1.5">Financial Governance & Operations</h5>
              <ul className="space-y-2 text-ink-soft list-disc list-outside ml-5 marker:text-ink">
                <li><strong className="text-ink font-extrabold">Financial Compliance:</strong> Managed tax compliance for a student-led initiative, handling declarations of exemption for e-invoice issuance.</li>
                <li><strong className="text-ink font-extrabold">Ledger Management:</strong> Established and maintained a comprehensive master ledger to track all expenditures, internal budgets, and receipts.</li>
                <li><strong className="text-ink font-extrabold">Sponsor Relations:</strong> Coordinated settlement details with corporate sponsors, managed vendor data requests, and established specific payment guidelines and verification requirements to ensure smooth transactions.</li>
                <li><strong className="text-ink font-extrabold">Committee Coordination:</strong> Directed financial planning and executed budget strategies across committee meetings to ensure all departments operated within their allocated funds.</li>
                </ul>
              </div>
        ...
        desc: (
          <div className="space-y-6 pt-2">
            ...
            <div className="space-y-2">
              <h5 className="font-display text-ink font-extrabold text-base uppercase tracking-[-0.01em] border-b-2 border-ink pb-1.5">Financial Governance & Operations</h5>
              <ul className="space-y-2 text-ink-soft list-disc list-outside ml-5 marker:text-ink">
                <li><strong className="text-ink font-extrabold">Expense Management:</strong> Processed and documented committee expenditures, including large-scale logistics and hospitality allocations (such as RM443.55 for committee meals), as well as printing and refreshments.</li>
                <li><strong className="text-ink font-extrabold">Ledger Maintenance:</strong> Maintained a highly detailed master ledger to record all transaction histories, ensuring complete transparency for audit and review purposes.</li>
                <li><strong className="text-ink font-extrabold">Financial Reporting:</strong> Reviewed and finalized the &quot;UM Alphathon 2025 Financial Implication&quot; document to establish clear budgetary baselines and reporting standards for the organizing committee.</li>
              </ul>
            </div>
          </div>
        )
        ...
        desc: (
          <div className="space-y-6 pt-2">
            ...
            <div className="space-y-2">
              <h5 className="font-display text-ink font-extrabold text-base uppercase tracking-[-0.01em] border-b-2 border-ink pb-1.5">Key Responsibilities & Governance</h5>
              <ul className="space-y-2 text-ink-soft list-disc list-outside ml-5 marker:text-ink">
                <li><strong className="text-ink font-extrabold">Budget Allocation:</strong> Managed and distributed event funding across various outreach activities, outperforming merchandise sales targets to secure a RM346 surplus.</li>
                <li><strong className="text-ink font-extrabold">Charity Execution:</strong> Executed the charity outreach effectively at RM11.68/pax, responsibly adjusting donations to match actual available funds.</li>
                <li><strong className="text-ink font-extrabold">Audit Compliance:</strong> Enforced strict documentation policies, verifying that every receipt was properly accounted for to maintain a 100%-reconciled budget.</li>
                <li><strong className="text-ink font-extrabold">Reporting Standards:</strong> Standardized the financial report formats used by the committee to maintain transparency and streamline the final administrative review process.</li>
                <li><strong className="text-ink font-extrabold">Reimbursement Policy Management:</strong> Administered transport reimbursement guidelines for event planning, deliberately excluding the 20% penalty deduction clause to ensure fair and complete compensation for committee members&apos; travel expenses.</li>
              </ul>
            </div>
          </div>
        )
  ...
  return (
    <div className="mt-8 rounded-[22px] sm:rounded-[26px] border-3 border-ink bg-paper-cream shadow-brutal-sm sm:shadow-brutal overflow-hidden">
      ...
      <div className="flex items-center gap-2.5 px-5 sm:px-6 py-3 border-b-3 border-ink bg-pop-cyan">
        ...
        <h4 className="text-sm font-mono font-extrabold text-ink uppercase tracking-[0.12em]">Treasurer Event Portfolio [4]</h4>
      </div>
        ...
        <div className="grid grid-cols-1 min-[360px]:grid-cols-2 lg:grid-cols-4 gap-3 mb-8">
          {stats.map((stat, i) => (
            ...
            >
              ...
              <div className="text-[0.7rem] font-mono font-bold text-ink/70 uppercase tracking-normal [overflow-wrap:anywhere]">{stat.label}</div>
              <div className="font-display text-lg sm:text-xl font-extrabold text-ink mt-0.5 leading-tight">{stat.value}</div>
            </div>
          ))}
        </div>
            ...
            return (
              <div
                ...
                className={`relative rounded-2xl border-3 border-ink transition-[box-shadow,transform,background-color] duration-200 ${
                  isExpanded ? "bg-white shadow-brutal" : "bg-white shadow-brutal-xs hover:-translate-y-0.5 hover:shadow-brutal-sm"
                }`}
              >
                <button
                  type="button"
...
export default function ExperienceSection() {
  ...
  return (
    ...
    >
      {/* Bauhaus accents */}
      <div aria-hidden className="pointer-events-none absolute -left-40 top-[45%] w-72 h-72 rounded-full border-3 border-ink bg-pop-yellow hidden xl:block" />
      <svg aria-hidden className="pointer-events-none absolute right-10 top-24 w-24 h-24 hidden lg:block" viewBox="0 0 100 100">
            ...
            {filteredExperiences.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  <div className={`flex flex-wrap items-center justify-between gap-3 sm:gap-4 px-4 xs:px-6 sm:px-10 py-3 sm:py-4 border-b-3 border-ink ${a.fill}`}>
                  ...
                  <div className="p-4 xs:p-6 sm:p-10">
                    ...
                    <div className="pb-7">
                      <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-5">
                        ...
                        <div className={`flex items-center gap-2.5 px-4 py-2.5 rounded-2xl border-3 border-ink shadow-brutal-sm shrink-0 self-start ${a.soft}`}>
                          <item.icon className="w-5 h-5 text-ink" strokeWidth={2.5} />
                          <span className="text-sm font-extrabold font-sans text-ink">
                            {item.organization}
                          </span>
                        </div>
                      </div>
                    ...
                    <div className="space-y-3.5 mb-8">
                      {item.bullets.map((bullet, bIdx) => (
                        <div key={bIdx} className="flex items-start gap-3 text-[0.95rem] text-ink-soft leading-relaxed font-sans font-medium max-w-4xl">
                          <div className={`w-6 h-6 rounded-full grid place-items-center shrink-0 mt-0.5 border-2 border-ink ${a.fill}`}>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-8">
                      {item.metrics.map((metric, mIdx) => (
                        <div key={mIdx} className={`rounded-2xl p-4 border-3 border-ink shadow-brutal-sm flex flex-col justify-center ${mIdx === 1 ? a.fill : "bg-white"}`}>
                          <span className="text-[0.7rem] font-mono font-bold text-ink/70 uppercase tracking-[0.08em] mb-1">{metric.label}</span>
                          <span className="font-display text-xl font-extrabold text-ink tracking-[-0.01em]">{metric.value}</span>
                        </div>
                      ))}
                    </div>
