                      ...
                      <div className="relative z-10 flex flex-col flex-1">
                        ...
                        <div className="mt-auto pt-6 border-t border-white/10 flex flex-col sm:flex-row sm:items-end justify-between gap-6">
                          ...
                          <div className="flex flex-col">
                            <span className="text-3xl font-black text-white tracking-tighterer"><AnimatedCounter value={item.statCallout.value} /></span>
      ...
      <AnimatePresence>
        {selectedCert && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 z-[10000] flex flex-col items-center justify-center p-12 sm:p-16 bg-black/90 backdrop-blur-xl"
            onClick={() => setSelectedCert(null)}
          >
            <div className="absolute top-4 right-4 sm:top-6 sm:right-6 z-[10010]">
              <button
                onClick={() => setSelectedCert(null)}
