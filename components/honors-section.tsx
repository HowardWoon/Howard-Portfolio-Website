        ...
        <div className="space-y-4 pt-1">
          ...
          <div className="bg-white border-2 border-ink rounded-xl overflow-hidden">
            <div className="bg-pop-mint px-3 py-2 border-b-2 border-ink flex flex-wrap justify-between items-center gap-x-3 gap-y-1">
              <span className="text-xs font-mono font-extrabold uppercase tracking-[0.08em] text-ink">Semester 2 Core</span>
            ...
            <div className="p-3 grid grid-cols-1 gap-2 text-xs font-mono font-medium">
              <div className="flex justify-between items-start group"><div className="flex gap-1.5 text-ink-soft group-hover:text-ink transition-colors flex-1 min-w-0 pr-2 [overflow-wrap:anywhere]"><span className="shrink-0 w-[4.6em] whitespace-nowrap">WIA1006</span><span className="shrink-0 text-ink-muted">·</span><span>Machine Learning</span></div><span className="w-6 text-right text-[#0F7A4A] font-extrabold shrink-0">A+</span></div>
              <div className="flex justify-between items-start group"><div className="flex gap-1.5 text-ink-soft group-hover:text-ink transition-colors flex-1 min-w-0 pr-2 [overflow-wrap:anywhere]"><span className="shrink-0 w-[4.6em] whitespace-nowrap">WIA1002</span><span className="shrink-0 text-ink-muted">·</span><span>Data Structure</span></div><span className="w-6 text-right text-[#0F7A4A] font-extrabold shrink-0">A+</span></div>
              <div className="flex justify-between items-start group"><div className="flex gap-1.5 text-ink-soft group-hover:text-ink transition-colors flex-1 min-w-0 pr-2 [overflow-wrap:anywhere]"><span className="shrink-0 w-[4.6em] whitespace-nowrap">WIA1003</span><span className="shrink-0 text-ink-muted">·</span><span>Computer System Architecture</span></div><span className="w-6 text-right text-[#0F7A4A] font-bold shrink-0">A</span></div>
              <div className="flex justify-between items-start group"><div className="flex gap-1.5 text-ink-soft group-hover:text-ink transition-colors flex-1 min-w-0 pr-2 [overflow-wrap:anywhere]"><span className="shrink-0 w-[4.6em] whitespace-nowrap">WIA1005</span><span className="shrink-0 text-ink-muted">·</span><span>Network Technology Foundation</span></div><span className="w-6 text-right text-[#0F7A4A] font-bold shrink-0">A</span></div>
              <div className="flex justify-between items-start group"><div className="flex gap-1.5 text-ink-soft group-hover:text-ink transition-colors flex-1 min-w-0 pr-2 [overflow-wrap:anywhere]"><span className="shrink-0 w-[4.6em] whitespace-nowrap">GIG1012</span><span className="shrink-0 text-ink-muted">·</span><span>Philosophy and Current Issues</span></div><span className="w-6 text-right text-[#0F7A4A] font-extrabold shrink-0">A+</span></div>
              <div className="flex justify-between items-start group"><div className="flex gap-1.5 text-ink-soft group-hover:text-ink transition-colors flex-1 min-w-0 pr-2 [overflow-wrap:anywhere]"><span className="shrink-0 w-[4.6em] whitespace-nowrap">GLT1025</span><span className="shrink-0 text-ink-muted">·</span><span>Effective Oral Communication</span></div><span className="w-6 text-right text-[#0F7A4A] font-extrabold shrink-0">A+</span></div>
            </div>
          </div>

          <div className="bg-white border-2 border-ink rounded-xl overflow-hidden">
            <div className="bg-pop-mint px-3 py-2 border-b-2 border-ink flex flex-wrap justify-between items-center gap-x-3 gap-y-1">
              <span className="text-xs font-mono font-extrabold uppercase tracking-[0.08em] text-ink">Semester 1 Core</span>
              <span className="text-xs font-mono font-bold text-ink">GPA: 4.00</span>
            </div>
            <div className="p-3 grid grid-cols-1 gap-2 text-xs font-mono font-medium">
              <div className="flex justify-between items-start group"><div className="flex gap-1.5 text-ink-soft group-hover:text-ink transition-colors flex-1 min-w-0 pr-2 [overflow-wrap:anywhere]"><span className="shrink-0 w-[4.6em] whitespace-nowrap">WIX1002</span><span className="shrink-0 text-ink-muted">·</span><span>Fundamentals of Programming</span></div><span className="w-6 text-right text-[#0F7A4A] font-extrabold shrink-0">A+</span></div>
              <div className="flex justify-between items-start group"><div className="flex gap-1.5 text-ink-soft group-hover:text-ink transition-colors flex-1 min-w-0 pr-2 [overflow-wrap:anywhere]"><span className="shrink-0 w-[4.6em] whitespace-nowrap">WIA2010</span><span className="shrink-0 text-ink-muted">·</span><span>Human Computer Interaction</span></div><span className="w-6 text-right text-[#0F7A4A] font-bold shrink-0">A</span></div>
              <div className="flex justify-between items-start group"><div className="flex gap-1.5 text-ink-soft group-hover:text-ink transition-colors flex-1 min-w-0 pr-2 [overflow-wrap:anywhere]"><span className="shrink-0 w-[4.6em] whitespace-nowrap">WIX1001</span><span className="shrink-0 text-ink-muted">·</span><span>Computing Mathematics I</span></div><span className="w-6 text-right text-[#0F7A4A] font-bold shrink-0">A</span></div>
              <div className="flex justify-between items-start group"><div className="flex gap-1.5 text-ink-soft group-hover:text-ink transition-colors flex-1 min-w-0 pr-2 [overflow-wrap:anywhere]"><span className="shrink-0 w-[4.6em] whitespace-nowrap">WIX1003</span><span className="shrink-0 text-ink-muted">·</span><span>Computer Systems and Organization</span></div><span className="w-6 text-right text-[#0F7A4A] font-bold shrink-0">A</span></div>
              <div className="flex justify-between items-start group"><div className="flex gap-1.5 text-ink-soft group-hover:text-ink transition-colors flex-1 min-w-0 pr-2 [overflow-wrap:anywhere]"><span className="shrink-0 w-[4.6em] whitespace-nowrap">GIG1003</span><span className="shrink-0 text-ink-muted">·</span><span>Basic Entrepreneurship Enculturation</span></div><span className="w-6 text-right text-[#0F7A4A] font-extrabold shrink-0">A+</span></div>
              <div className="flex justify-between items-start group"><div className="flex gap-1.5 text-ink-soft group-hover:text-ink transition-colors flex-1 min-w-0 pr-2 [overflow-wrap:anywhere]"><span className="shrink-0 w-[4.6em] whitespace-nowrap">GLT1024</span><span className="shrink-0 text-ink-muted">·</span><span>Proficiency in English III</span></div><span className="w-6 text-right text-[#0F7A4A] font-bold shrink-0">A</span></div>
            </div>
          </div>
        </div>
      ),
  ...
  },
  {
    ...
    statCallout: { value: "4.00", label: "Physical Sciences Cohort" },
        ...
        <div className="space-y-4 pt-1">
          ...
          <div className="bg-white border-2 border-ink rounded-xl overflow-hidden">
            <div className="bg-pop-mint px-3 py-2 border-b-2 border-ink flex flex-wrap justify-between items-center gap-x-3 gap-y-1">
              <span className="text-xs font-mono font-extrabold uppercase tracking-[0.08em] text-ink">National & State Excellence</span>
              <span className="text-xs font-mono font-bold text-ink">KMNS 2024/2025</span>
            </div>
            <div className="p-3 grid grid-cols-1 gap-2 text-xs font-mono font-medium">
              <div className="flex justify-between items-center group"><span className="text-ink-soft group-hover:text-ink transition-colors min-w-0 pr-2 [overflow-wrap:anywhere]">SUKED Ping Pong Coach (Negeri)</span><span className="w-24 text-right text-[#8A5A00] font-extrabold shrink-0">GOLD</span></div>
              <div className="flex justify-between items-center group"><span className="text-ink-soft group-hover:text-ink transition-colors min-w-0 pr-2 [overflow-wrap:anywhere]">Matrix eXtra Quiz Challenge (Kebangsaan)</span><span className="w-24 text-right text-[#B4531A] font-extrabold shrink-0">BRONZE</span></div>
              <div className="flex justify-between items-center group"><span className="text-ink-soft group-hover:text-ink transition-colors min-w-0 pr-2 [overflow-wrap:anywhere]">SUKED Tenis Lelaki (Negeri)</span><span className="w-24 text-right text-[#B4531A] font-extrabold shrink-0">BRONZE</span></div>
              <div className="flex justify-between items-center group"><span className="text-ink-soft group-hover:text-ink transition-colors min-w-0 pr-2 [overflow-wrap:anywhere]">IMONST 1 Math Olympiad (Kebangsaan)</span><span className="w-24 text-right text-ink-muted font-bold shrink-0">FINALIST</span></div>
              <div className="flex justify-between items-center group"><span className="text-ink-soft group-hover:text-ink transition-colors min-w-0 pr-2 [overflow-wrap:anywhere]">Kursus Kepimpinan Generasi Madani (Kebangsaan)</span><span className="w-24 text-right text-ink-muted font-bold shrink-0">MOE</span></div>
              <div className="flex justify-between items-center group"><span className="text-ink-soft group-hover:text-ink transition-colors min-w-0 pr-2 [overflow-wrap:anywhere]">Bicara Eksekutif Kenegaraan Madani (Kebangsaan)</span><span className="w-24 text-right text-ink-muted font-bold shrink-0">MOE</span></div>
              <div className="flex justify-between items-center group"><span className="text-ink-soft group-hover:text-ink transition-colors min-w-0 pr-2 [overflow-wrap:anywhere]">Pertandingan Komik STEM 2024 (Negeri)</span><span className="w-24 text-right text-ink-muted font-bold shrink-0">PARTICIPANT</span></div>
              <div className="flex justify-between items-center group"><span className="text-ink-soft group-hover:text-ink transition-colors min-w-0 pr-2 [overflow-wrap:anywhere]">Pertandingan Poster AI (Negeri)</span><span className="w-24 text-right text-ink-muted font-bold shrink-0">PARTICIPANT</span></div>
              <div className="flex justify-between items-center group"><span className="text-ink-soft group-hover:text-ink transition-colors min-w-0 pr-2 [overflow-wrap:anywhere]">Konvensyen Profesional KMNS 2024 (Negeri)</span><span className="w-24 text-right text-ink-muted font-bold shrink-0">PARTICIPANT</span></div>
            </div>
          </div>

          <div className="bg-white border-2 border-ink rounded-xl overflow-hidden">
            <div className="bg-pop-mint px-3 py-2 border-b-2 border-ink flex flex-wrap justify-between items-center gap-x-3 gap-y-1">
              <span className="text-xs font-mono font-extrabold uppercase tracking-[0.08em] text-ink">Leadership & Mentorship Roles</span>
              <span className="text-xs font-mono font-bold text-ink">KEY POSITIONS</span>
            </div>
            <div className="p-3 grid grid-cols-1 gap-2 text-xs font-mono font-medium">
              <div className="flex justify-between items-center group"><span className="text-ink-soft group-hover:text-ink transition-colors min-w-0 pr-2 [overflow-wrap:anywhere]">Sukan Kampung</span><span className="text-[#0F7A4A] font-extrabold shrink-0">CHAIRMAN</span></div>
              <div className="flex justify-between items-center group"><span className="text-ink-soft group-hover:text-ink transition-colors min-w-0 pr-2 [overflow-wrap:anywhere]">Peer Assisted Learning (PAL)</span><span className="text-[#0F7A4A] font-extrabold shrink-0">VICE PRESIDENT</span></div>
              <div className="flex justify-between items-center group"><span className="text-ink-soft group-hover:text-ink transition-colors min-w-0 pr-2 [overflow-wrap:anywhere]">Maths Support System (MSS)</span><span className="text-[#0F7A4A] font-bold shrink-0">MENTOR</span></div>
              <div className="flex justify-between items-center group"><span className="text-ink-soft group-hover:text-ink transition-colors min-w-0 pr-2 [overflow-wrap:anywhere]">Program Chemcare Sem 2</span><span className="text-[#0F7A4A] font-bold shrink-0">FACILITATOR</span></div>
              <div className="flex justify-between items-center group"><span className="text-ink-soft group-hover:text-ink transition-colors min-w-0 pr-2 [overflow-wrap:anywhere]">Gemersik Cakna x Pesta Tanglung</span><span className="text-[#0F7A4A] font-bold shrink-0">FACILITATOR</span></div>
            </div>
          </div>
        </div>
      ),
...
function CertificateModal({ url, onClose }: { url: string; onClose: () => void }) {
  ...
  return createPortal(
    ...
    >
      ...
      <div className="flex items-center justify-end gap-2 mb-3 sm:mb-4 shrink-0 w-full max-w-5xl mx-auto" onClick={(e) => e.stopPropagation()}>
        {isPdf && (
        ...
        {isPdf ? (
          ...
          >
            ...
            <div className="w-full h-full grid place-items-center p-6 text-center">
              <a href={url} target="_blank" rel="noopener noreferrer" className="nb-btn nb-btn-yellow px-6 py-4 text-sm">
...
export default function HonorsSection() {
  ...
  const pick = (id: typeof activeCategory) => {
    ...
    if (id && window.innerWidth < 768) {
      window.setTimeout(() => {
        ...
        if (!el) return;
        if (window.__lenis) window.__lenis.scrollTo(el, { offset: -(parseInt(getComputedStyle(document.documentElement).getPropertyValue("--header-h")) || 72) - 12 });
  ...
  return (
    ...
    >
              ...
              >
                {activeItems.map((item, itemIdx) => {
                  ...
                  return (
                    ...
                    >
                      {/* Top Bar */}
                      <div className={`flex flex-wrap items-center justify-between gap-3 px-6 py-3.5 border-b-3 border-ink ${isFeatured ? c.fill : c.soft}`}>
                      ...
                      {/* Featured Watermark */}
                      {isFeatured && (
                        <div aria-hidden className="absolute -right-10 top-10 opacity-[0.06] pointer-events-none rotate-12 group-hover:rotate-6 transition-transform duration-700">
                      ...
                      <div className="relative z-10 flex flex-col flex-1 p-4 xs:p-6 sm:p-7">
                        ...
                        <div className="space-y-2.5 mb-8">
                          {item.highlights.map((hl, hlIdx) => (
                            <div key={hlIdx} className="flex items-start gap-2.5 text-sm text-ink-soft font-sans font-medium">
                              <div className={`w-5 h-5 rounded-full grid place-items-center shrink-0 mt-0.5 border-2 border-ink ${c.fill}`}>
                        ...
                        <div className="mt-auto pt-6 border-t-2 border-dashed border-ink flex flex-wrap items-end justify-between gap-5">
                          ...
                          <div className="flex flex-col items-start">
                            <span className={`font-display text-3xl font-extrabold text-ink tracking-[-0.03em] leading-none px-3 py-1.5 rounded-xl border-3 border-ink shadow-brutal-sm -rotate-2 ${c.fill}`}>
      ...
      <AnimatePresence>
        {selectedCert && (
          <CertificateModal url={selectedCert} onClose={() => setSelectedCert(null)} />
        )}
      </AnimatePresence>
    </section>
  );
