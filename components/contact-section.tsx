      ...
      <div className="max-w-7xl mx-auto space-y-16">
        ...
        <footer className="border-t border-white/10 pt-10 pb-6 space-y-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            {/* Right Quick Nav Directory */}
            <div className="flex flex-wrap items-center justify-center gap-4 text-xs font-mono text-neutral-400">
              <a href="#about" className="hover:text-amber-400 transition-colors">01 // VISION</a>
              <a href="#projects" className="hover:text-amber-400 transition-colors">02 // ARCHITECTURE</a>
